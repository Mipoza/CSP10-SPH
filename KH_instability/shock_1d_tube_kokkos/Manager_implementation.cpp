...
int main(int argc, char* argv[]) {
    ...
    {   
        ...
        R_part_0.push_back(Vector<double, 1>(extent[0]*i/((double)N_particles*fac) * 0.5));
        v_part_0.push_back(Vector<double, 1>(v));
        m_part_0.push_back(mass);
        E_part_0.push_back(10.0);
    ...
    std::vector<double> velocity;
      ...
      if(visc){
        file_p.open("../pressures/pressures_pos_new" + std::to_string(i) + ".dat");
        file_rho.open("../densities/densities_pos_new" + std::to_string(i) + ".dat");
        file_v.open("../velocities/velocities_pos_new" + std::to_string(i) + ".dat");
      } else{
